...
if (!isset($_SESSION['user_role']) || $_SESSION['user_role'] !== 'shopkeeper') {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
              <div class="container-fluid">
                  <a class="navbar-brand" href="index.php">
                      <i class="fas fa-store me-2"></i>DUKA Shopkeeper Portal
                  </a>
                  <div class="d-flex align-items-center">
                      <a href="shopkeeper_dashboard.php" class="btn btn-outline-light me-3">
                ...
                <div class="card p-5 fade-in">
                    ...
                    <form action="addproduct.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2 mt-4">
                            ...
                            <a href="shopkeeper_dashboard.php" class="btn btn-light rounded-pill btn-lg">
                                Cancel
                            </a>
                        </div>
                    </form>
